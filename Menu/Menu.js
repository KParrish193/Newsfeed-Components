...
*/
  ...
  function menuCreate(array){
    ...
    array.forEach(item => {
      ...
      unList.append(menuListItem);
    });
    
    menuDiv.appendChild(unList);

    const buttonClick = document.querySelector('.menu-button');
    ...
    const menuAttach = document.querySelector('.header');
    
    menuAttach.appendChild(menuCreate(menuItems));